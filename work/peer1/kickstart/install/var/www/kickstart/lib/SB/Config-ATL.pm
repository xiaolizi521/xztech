...
$Config = {
	...
	ks_host           => "winstart.atl.corp.peer1.net",
	ks_ipaddr         => "10.1.0.2",
	ks_public_ipaddr  => "192.168.37.100",
        ks_public_network => "192.168.37.0",
        ks_public_netmask => "255.255.255.128",
        ks_public_gateway => "192.168.37.1",
