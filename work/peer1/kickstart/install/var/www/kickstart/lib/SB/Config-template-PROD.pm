...
$Config = {
    ...
    adm_www_host => "admin.serverbeach.com",
    adm_www_user => "kickstart",
    adm_www_pass => "l33tNix",

    net_www_host => "netadmin.@@DC_ABBR@@.serverbeach.com",
    net_www_user => undef, 
    net_www_pass => undef,

    ocean_host  => "admin.serverbeach.com",
    ocean_user  => "kickstart",
    ocean_pass  => "l33tNix",

    pit_www_host => "ocean.serverbeach.com/provisioneer",
    pit_www_user => "kickstart",
    pit_www_pass => "l33tNix",

    net_db_host	=> "netadmin.@@DC_ABBR@@.serverbeach.com",
