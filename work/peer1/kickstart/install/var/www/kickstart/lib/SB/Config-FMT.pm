...
$Config = {
        ...
        ks_host           => "winstart.fmt.corp.peer1.net",
        ks_ipaddr         => "10.1.0.2",
        ks_public_ipaddr  => "192.168.48.30",
        ks_public_network => "192.168.48.0",
        ks_public_netmask => "255.255.254.0",
        ks_public_gateway => "192.168.48.2",
