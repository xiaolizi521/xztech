	...
	<div id="content-wrap">
		...
		<div id="content">
			...
			<?php
				...
				$query = "SELECT id FROM vlans order by id";

				$result = pg_query($query) or die("Couldnt' execute query.");
				$num = pg_numrows($result);
			?>
			
			<div class="featurebox"><h3>Update the SAT Kickstart Database</h3><p>
				<form action= "delete2.php" name="delete" id="delete" method="post">
				<select value="" size="1" name="id">
