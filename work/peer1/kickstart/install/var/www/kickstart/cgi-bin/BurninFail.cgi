...
# Pull all records from the KS Database where Burnin has reported "Fail" into an array.
my $macListResult = $ksdbh->selectall_arrayref("SELECT mac_address FROM kickstart_map WHERE new_status = 'burnin_fail'");
