...
#
# File Type:            CGI
# File Name:            preseed.cgi
#
# Description:
#    This script is used to generate the preseed.cfg file used for future Debian
...
sub get_kscfg 
{
    ...
    my $kscfg = $Config->{ks_home}."/kscfg/preseed.cfg";
...
{       
        kslog('info',"Wordpress Nonprofit server preseed file requested by $ipaddr");
        $osload = 'wpnonprofit';
