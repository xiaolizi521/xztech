...
$action = "Submitting new font";
    #database is less reliable than the file itself. If there is already an entry in our database, why bother wasting more precious CPU?
	
	mysql_query("INSERT INTO `fonts` (`name`,`file`) VALUES ('$base','$name')");
