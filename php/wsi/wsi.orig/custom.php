...
if ($_POST['submit']) {
	...
	if (!$x) {
		...
		`tranke` = '$tranke', `path` = '$path', `theme` = '$bg', `se` = '$se', `be` = '$be', `email` = '$email'
...
<table cellspacing='0' cellpadding='0' style='margin-top: 10px;'>
	<tr>
		<td class='chead'>Image Specifications</td>
		<td width='5px'></td>
	...
	<tr>
		...
		<td></td>
		<td class='cstuff' valign='top' align='right'>X Co-ordinate: <? echo "<input type='text' value='$data[tmcx]' name='cx' size='3'>" ?><br>
		Y Co-ordinate: <? echo "<input type='text' value='$data[tmcy]' name='cy' size='3'>" ?><br>
		Enabler: <select name='ce'>
		<?
		...
		<td></td>
		<td class='cstuff' valign='top' align='right'>X Co-ordinate: <? echo "<input type='text' value='$data[rankx]' name='rx' size='3'>" ?><br>
		Y Co-ordinate: <? echo "<input type='text' value='$data[ranky]' name='ry' size='3'>" ?><br>
		Enabler: <select name='re'>
		<?
	...
	<tr>
		<td class='cstuff' valign='top' align='right'>X Co-ordinate: <? echo "<input type='text' value='$data[tnamex]' name='tnamex' size='3'>" ?><br>
		Y Co-ordinate: <? echo "<input type='text' value='$data[tnamey]' name='tnamey' size='3'>" ?><br>
		Enabler: <select name='tnamee'>
		<?
		...
		<td></td>
		<td class='cstuff' valign='top' align='right'>X Co-ordinate: <? echo "<input type='text' value='$data[tkeysx]' name='tkeysx' size='3'>" ?><br>
		Y Co-ordinate: <? echo "<input type='text' value='$data[tkeysy]' name='tkeysy' size='3'>" ?><br>
		Enabler: <select name='tkeyse'>
		<?
		...
		<td></td>
		<td class='cstuff' valign='top' align='right'>X Co-ordinate: <? echo "<input type='text' value='$data[tclicksx]' name='tclicksx' size='3'>" ?><br>
		Y Co-ordinate: <? echo "<input type='text' value='$data[tclicksy]' name='tclicksy' size='3'>" ?><br>
		Enabler: <select name='tclickse'>
		<?
		...
		<td></td>
		<td class='cstuff' valign='top' align='right'>X Co-ordinate: <? echo "<input type='text' value='$data[trankx]' name='trankx' size='3'>" ?><br>
		Y Co-ordinate: <? echo "<input type='text' value='$data[tranky]' name='tranky' size='3'>" ?><br>
		Enabler: <select name='tranke'>
		<?
		...
		<td></td>
		<td class='cstuff' valign='top' align='right'>X Co-ordinate: <? echo "<input type='text' value='$data[countryx]' name='countryx' size='3'>" ?><br>
		Y Co-ordinate: <? echo "<input type='text' value='$data[countryy]' name='countryy' size='3'>" ?><br>
		Enabler: <select name='countrye'>
		<?
