...
if ( ereg ( '/online', $_GET[$ident] ) ) {
	...
	<tr>
		<td><b>Username</b></td>
		<td><b>Location</b></td>
		<td style="width: 95px; text-align: center;"><b>Last Activity</b></td>
		<td style="width: 50px; text-align: center;"><b>Contact</b></td>
	</tr>
';
...
';
		...
		$last_activity_url = htmlentities ( $last_activity_url, ENT_COMPAT );
		$last_activity_title = htmlentities ( $last_activity_title, ENT_COMPAT );
		$last_activity_title = str_replace( '&amp;amp;', '&amp;', $last_activity_title );
		echo '		<td>Viewing ', $last_activity_location, ':<br />
			&raquo; <a href="', $last_activity_url, '">', $last_activity_title, '</a></td>
		<td style="width: 95px; text-align: center;">', $last_activity_time, '</td>
		<td style="width: 50px; text-align: center;">', $last_activity_contact, '</td>
	</tr>
';
	}
