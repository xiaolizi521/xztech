...
if ($i <= 303)
 {
 echo'<tr bgcolor='.$color.'><td>Chapter '.$i.': '.$shorttitle.'</td><td>
...
echo
  '
 <tr bgcolor='.$color.'><td>Chapter 304: CHAPTER TITLE HERE</td>
 <td>
 <a href="index.php?page=media/downloads&file=153824&t=raw">Download Raw</a>
 </td> ';
*/
 echo '
 <tr bgcolor='.$color.'><td>Chapter -15: Death in the Field of Ice</td>
 <td>
 <a href="index.php?page=media/downloads&file=153823&t=raw">Download Raw</a>
 </td>
 ';
 }
 elseif($i == 305)//Give 304 Link
 {
echo
  '

 <tr bgcolor='.$color.'><td>Chapter 304: Battle of Barbarians</td>
 <td>
 <a href="index.php?page=media/downloads&file=153824&t=raw">Download Raw</a>
 </td> ';
 ...
 elseif($i == 306)//Give 305 Link
 {
echo
  '

 <tr bgcolor='.$color.'><td>Chapter 305: The Rising Phoenix</td>
 <td>
 <a href="index.php?page=media/downloads&file=153825&t=raw">Download Raw</a>
 </td> ';
