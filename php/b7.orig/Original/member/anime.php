...
$index = mysql_query ( "SELECT * FROM episodes WHERE type = 'sub' ORDER BY `episode` DESC LIMIT 5" );
...
Episodes older than five week old will be removed, so grab them while they're hot! Each episode is subbed by Dattebayo or Flomp-Rumbel unless noted otherwise.<br />
<br />
<b>Donate</b><br />
...
<br /><br />
<div class="vol">Latest Dattebayo Release</div><hr />
<table width="100%">
<?PHP
...
<tr bgcolor="'.$color.'"> 
 ...
 <td>
 <a href="?page=media/downloads&t=animesub&file='.$chapter['id'].'">Download Episode!</a>
 </td> 
</tr>
';
}
