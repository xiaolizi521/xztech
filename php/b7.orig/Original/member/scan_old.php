...
<div class="vol">Latest 5 Releases</div><hr />

<table width="100%">

<?

for($i = $chapters; $i > $latest5; $i--)

{

if($i == 306)
{  $anpan = 'Download Chinese Scanlation'; }
else
{  $anpan = 'Download Chinese Scanlation'; }
...
$color = ( $i % 2 == 0 ) ? "#eeeeee" : "";
 ...
 if($chapterinfo['stage'] == 1 && $i != 305)//Give speedscan link
 {
 echo'<tr bgcolor='.$color.'><td>Ch.'.$i.': <em>'.$shorttitle.'</em></td>

 <td>

 <a href="index.php?page=media/downloads&file='.$id.'&t=speed">'.$anpan.'</a>

 </td>';
 }
 elseif($chapterinfo['stage'] == 2 && $i != 304 && $i != 305)//Give M7 Link
 {
 echo '<tr bgcolor='.$color.'><td>Ch.'.$i.': <em>'.$shorttitle.'</em></td>
 <td>
 ...
 elseif($i == 304) //Give -15 Link
 {
echo
  '
 <tr bgcolor="#F7F6F1"><td>Ch.304: <em>Battle of Barbarians</em></td>
 <td>
 <a href="index.php?page=media/downloads&file=153824&t=scan">Download Chapter</a>
 </td> '; 

 echo '
 <tr bgcolor='.$color.'><td>Ch.-15: <em>Death in the Field of Ice</em></td>
 <td>
 <a href="index.php?page=media/downloads&file=153823&t=scan">Download Chapter</a>
 </td>
 ';
 }
...
<div class="vol">Previous Releases</div><hr />
...
$shorttitle = Truncate($title, 30);
 ...
 elseif($chapterinfo['stage'] == 2 && $i != 304)//Give Final Link
 ...
 ';
  ...
  elseif($chapterinfo['stage'] == 2 && $i == 304)//Give -15 Link
 {
 echo '<tr bgcolor='.$color.'><td>Ch.-15: <em>Death in the Field of Ice</em></td>
 <td>
 <a href="index.php?page=media/downloads&file=153823&t=scan">Download Chapter</a>
 </td>
 ';
