...
$rss = '<?xml version="1.0" encoding="US-ASCII" ?>
';
$rss .= '<rss version="2.0">
	<channel>
		...
		<copyright>Copyright 2004 - 2006</copyright>
		<generator>automatic</generator>
		<managingEditor>tseltman@comcast.net (Hinalover)</managingEditor>
		<webMaster>bleach7@gmail.com (Kon)</webMaster>
...
';
$rss .= '</rss>';
( $fp = fopen ( '/home/bleach7/public_html/rss.xml', 'w' ) ) or die ( 'couldn\'t open' );
fwrite ( $fp, $rss );
fclose ( $fp );
?>