...
// Change this configuration section to your appropriate geographical location
...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="rackwatch.js"></script> 
		...
		<table>
			...
			<tr>
				<td>
					...
					Hostname: <input name="host" id="host" type="text" value="" />
