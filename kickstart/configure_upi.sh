...
####################################################################################
# Filename: configure_upi.sh
# Description: 	This bash script can be used to reconfigure a kickstart server into
#               a kickstart-upi server.
#
# Author: Scott Ferry 
#
#
# Date: Nov 16th, 2009
# https://pforge.peer1.com/svnroot/kickstart/trunk/exports/kickstart/configure_upi.sh
#
# changelog:
# sferry@2009-12-01:    * initial file
#
#################################################################################
...
#    ln -sf mhrescue /tftpboot/pxe/pxelinux.cfg/sbrescue
