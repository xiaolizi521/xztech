...
my $update_base = "/mirrors/fedora/fedora/1/i386/RPMS.updates";
my $target = "/exports/installs/linux/fedora/core1/Fedora/RPMS";
my $doit = undef;
...
if ($doit) {
    ...
    system("/usr/lib/anaconda-runtime/genhdlist","/exports/installs/linux/fedora/core1/");
    print "done.\n";
}
