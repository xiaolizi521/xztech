...
#
# File Type:            CGI
# File Name:            challengegm.cgi
#
# Description:
#    This script is used to generate the challengegm.cfg file used for future Debian
#    based installs of Ubuntu.
# 
#-------------------------------------------------------------------------------
...
{       
        kslog('info',"Challenge Games custom image requested by $ipaddr");
        $osload = 'challengegm';
