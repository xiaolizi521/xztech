...
$Config = {
	...
	ks_domain         => "kslan.ldn1.peer1.com",
	ks_host           => "kickstart.ldn1.peer1.com",
	ks_ipaddr         => "10.2.0.2",
	ks_public_ipaddr  => "83.222.224.168",
	ks_public_network => "83.222.224.160",
	ks_public_netmask => "255.255.255.240",
	ks_public_gateway => "83.222.224.161",
