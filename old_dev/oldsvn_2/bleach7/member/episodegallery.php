...
if($epi=='null')
{
 ...
 <option value="ddr">DiamondDust Rebellion</option>
 ';
...
if($epi >= 169)
{$omni = 'Screenshots used with permission from <a href="?page=member/member&id=omniscient73">Omni</a> of <a href="http://randomc.animeblogger.net/" target="_blank">Random Curiosity</a>.<br /><br />';}
else
{$omni = '';}
...
<td align="right">
 ...
 <option value="mon">Memories of Nobody</option>
 <option value="ddr">DiamondDust Rebllion</option>
 ';
 for($i = $episodes; $i != 0; $i--)
 {
...
for($i = 0; $i < $count; $i++)
{
 ...
 {$i = '0'.$i;}
  ...
  <table border="0" class="artg"><tr><td align="center">
   <a href="'.$dir.'e'.$epi.' - '.$i.'.jpg"><img src="member/images/screencaps/thumbs/e'.$epi.' - '.$i.'.jpg" width="140" /></>
  </td></tr></table>
  </td>
  ';
  if($i % 3 == 0)
...
elseif($epi == 'ddr')
{
$dir = "member/images/screencaps/ddr/";
$count = count(glob($dir . "*")); 
echo'
<table width="100%">
<tr>
<td align="left"><h3>Bleach: DiamondDust Rebellion.</h3><td>
<td align="right">
 <form action="?page=member/episodegallery" method="post">
 <select name="episode" class="form">
 <option value="ddr">DiamondDust Rebllion</option>
