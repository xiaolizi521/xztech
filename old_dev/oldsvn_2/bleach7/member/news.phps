...
echo "<center>No news items have been added</center>";
} else {
...
$comments = "<a href='$site_url/$main_filename?$ident=$script_folder/comments&id=$show_news[id]&pg=$pages_num' target='_top'>$comments</a>";
}
