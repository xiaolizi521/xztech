...
<center><a href="', $current_location, '">Back to editting your ' . strtolower( $type ) . '</a></center>';
}
...
if ( isset ( $_POST['edit_profile'] ) ) {
  ...
  $errorCount--;
  echo'<center><font color="red"><b>Profile could not be updated.<br /><br />The following error(s) were found:<br />';
