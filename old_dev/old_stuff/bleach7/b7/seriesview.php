...
/*
		...
		';
*/
//		echo '<br /><br /><fieldset><legend><b>Chapter Menu</b></legend><br /><center>';

//		echo '<a href="http://www.toshokan.bleach7.com/'.$mangainfo['directory'].'"><font size="2">Read Now!</font></a>';
//		echo '<form action=""><select onchange="window.open(this.options[this.selectedIndex].value,\'_top\')" name="ch"><option disabled="disabled" selected="selected">Select Chapter</option>';
		readfile('http://www.toshokan.bleach7.com/seriesview.php?manga='.$manga);
/*
		if ($manga != 'bleach')
...
*/
//		echo '<option value="http://www.toshokan.bleach7.com/'.$mangainfo['directory'].'">Read Now!</option>';
