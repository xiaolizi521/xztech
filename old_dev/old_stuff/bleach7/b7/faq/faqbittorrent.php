...
<br />
Because the series has been licensed by Viz back in March of 2006, it's a lot harder to find older releases of the series.  For episode 50 to the present, you can download from <a href="http://dattebayo.com" target="_blank">Dattebayo</a>.  However for previous releases, you can search <a href="http://www.tokyotosho.com/" target="_blank">Tokyotosho</a> for any releases.  Tokyotosho also gives links to torrents for the English dubbing of the series.<br />
<br />
...
<br />
There are several major Bittorrent programs available on the internet, all of which are free. The original Bittorrent program was designed by the originator of Bittorrent, Bram Cohen. You can download the file off of <a href="http://www.bittorrent.com/index.html" target="_blank">his website.</a><br />
<br />
If you are a fan of C++, there is another fully functional Bittorrent program made entirely in C++ called uTorrent (microTorrent). This is designed with many functions for the advanced user, as well as a nice looking front end for management's sake. This client was designed to use as little of your computer's resources as possible, so if you have a lower powered computer, uTorrent is the right client for you. You can download the program at <a href="http://www.utorrent.com/" target="_blank">http://www.utorrent.com/</a>.<br />
<br />
If you are more of a fan of Java, there is a fully functional Bittorrent program made entirely in Java. This program is called Azureus. It has many functions for the advanced users as well as a well designed front-end for easy management of all of your torrent files. You can download the file at <a href="http://azureus.sourceforge.net/" target="_blank">http://azureus.sourceforge.net/</a>.<br />
<br />
For those who wish for just a program, but no real advanced functions, you can download the simple BitTornado. This doesn't have much of a user interface, but it does the job nicely. You can download the file from <a href="http://www.bittornado.com/" target="_blank">http://www.bittornado.com/</a>.<br />
<br />
