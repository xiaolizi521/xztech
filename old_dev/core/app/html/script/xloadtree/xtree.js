...
WebFXTreeAbstractNode.prototype.deSelect = function() {
    if( document.getElementById(this.id + '-anchor').focus ) { // Only do this on Anchors
...
function WebFXTree(sText, sAction, sBehavior, sIcon, sOpenIcon) {
	...
	webFXTreeHandler.changeClasses = webFXTreeConfig.defaultChangeClasses;
}
...
WebFXTree.prototype.setChangeClasses = function (sChangeClasses) {
	webFXTreeHandler.changeClasses =  sChangeClasses;
};

WebFXTree.prototype.getChangeClasses = function (sChangeClasses) {
	return webFXTreeHandler.changeClasses;
};
...
WebFXTree.prototype.toString = function() {
    ...
    if( this.action == webFXTreeConfig.defaultAction ) {
        str += "<div id=\"" + this.id + "-anchor\"" +
        " style=\"display: inline\"" +
		" class=\"webfx-tree-item-anchor webfx-tree-item-anchor-div\">" + this.text + "</div>";
    } else {
        str += "<a href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" onblur=\"webFXTreeHandler.blur(this);\"" +
		(this.target ? " target=\"" + this.target + "\"" : "") +
		"class=\"webfx-tree-item-anchor webfx-tree-item-anchor-a\">" + this.text + "</a>";
    }
