...
REQUIRE_ONCE("EXT_CONT_delete_email_logic.php");
...
<!-- Begin Edit Email ------------------------------------------------------ -->
	...
	<TR>
		<TD><IMG SRC="/images/tbl-left-top.jpg" 
				 ...
				 ALT=""></TD>
		<TD BGCOLOR="#003399" 
		    CLASS="hd3rev"> Delete Email Confimation </TD>
	...
	<TR>
		...
		<TD>
            <FORM ACTION="EXT_CONT_delete_email_handler.php">
			<?=$hidden_tags ?>
			...
			<?=$contact->individual->lastName ?>? </FONT>
