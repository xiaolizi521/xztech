  ...
  public $team;
	...
	function __construct () {
	  ...
	  $this->db_host = 'localhost';
	  	$this->db_user = 'offbeatz_whatpul';
	  	$this->db_pass = 'pulsestats';
	  	$this->db_name = 'offbeatz_pulsestats';
	...
	function update() {
		...
		//	echo $this->name . "<br>";
	  	if ($this->team) {
			...
			. "', tname ='" . mysql_real_escape_string($this->teamname)
			...
			. "', tmembers = '" . $this->teammembers ."' where user = '" . mysql_real_escape_string($this->name) . "'";
			...
			. "', tmc = '" . str_replace(",","",$this->clicks)
			. "', rank ='" . str_replace(",","",$this->rank)
			. "', country ='" . $this->country ."' where user = '" . mysql_real_escape_string($this->name) . "'";
		}
		/*}
		else {
...
"," . $this->keys . "," . $this->clicks . "," . $this->rank . "," . mysql_real_escape_string($this->teamname). "," . $this->teamkeys . "," . $this->teamclicks . "," . $this->teamrank . "," . $this->country . "," . $this->teammembers . ")";
				}*/
