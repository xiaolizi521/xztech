...
function thumbnailgif($image_path,$thumb_path,$image_name,$resize)
		...
		<tr>
		 <td><a href="http://www.bleach7.com/member/images/screencaps/Episode '.$episode.'/e'.$episode.' - '.$img1.'.jpg"><img src="'.$file1.'" alt="Episode Preview 1" /></a>
		 <td><a href="http://www.bleach7.com/member/images/screencaps/Episode '.$episode.'/e'.$episode.' - '.$img2.'.jpg"><img src="'.$file2.'" alt="Episode Preview 2" /></a>
		 <td><a href="http://www.bleach7.com/member/images/screencaps/Episode '.$episode.'/e'.$episode.' - '.$img3.'.jpg"><img src="'.$file3.'" alt="Episode Preview 3" /></a>
		</tr>
		</table>
		</center>
		';
		...
		<table border=0 class="artg" cellpadding="0" cellspacing="0">
		<tr>
		 <td><a href="http://www.bleach7.com/member/images/screencaps/movie/e'.$episode.' - '.$img1.'.jpg"><img src="'.$file1.'" alt="Movie Preview 1" /></a>
		 <td><a href="http://www.bleach7.com/member/images/screencaps/movie/e'.$episode.' - '.$img2.'.jpg"><img src="'.$file2.'" alt="Movie Preview 2" /></a>
		 <td><a href="http://www.bleach7.com/member/images/screencaps/movie/e'.$episode.' - '.$img3.'.jpg"><img src="'.$file3.'" alt="Movie Preview 3" /></a>
		</tr>
		</table>
		</center>
		';
