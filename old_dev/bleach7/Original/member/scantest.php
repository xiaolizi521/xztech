...
//$chaptersLate5 = mysql_query ( "SELECT * FROM manga_chapters WHERE stage > 0 ORDER BY id DESC LIMIT 5" );
//$chaptersAll = mysql_query ( "SELECT * FROM manga_chapters WHERE stage > 0 ORDER BY id ASC" );
