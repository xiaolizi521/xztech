...
<tr>
<td align='right'>
Red:<input id='selred' type='text' name='selred' size='3' maxlength='3' onChange='colourChange2()'><br>
Green:<input id='selgreen' type='text' name='selgreen' size='3' maxlength='3' onChange='colourChange2()'><br>
Blue:<input id='selblue' type='text' name='selblue' size='3' maxlength='3' onChange='colourChange2()'><br>
Light/Dark:
...
Red:<? echo "<input id='namered' type='text' name='namered' size='3' maxlength='3' onChange='colourChange3()' value='$data[fontred]'>"; ?><br>
Green:<? echo "<input id='namegreen' type='text' name='namegreen' size='3' maxlength='3' onChange='colourChange3()' value='$data[fontgreen]'>"; ?><br>
Blue:<? echo "<input id='nameblue' type='text' name='nameblue' size='3' maxlength='3' onChange='colourChange3()' value='$data[fontblue]'>"; ?><br>
<input type='button' onclick='sendtoname()' value='Send to Name'>
</td>
<td><div id='namecolour' class='box'>&nbsp;</div></td>
<td align='right' valign='top'>
Red:<? echo "<input id='sred' type='text' name='sred' size='3' maxlength='3' onChange='colourChange5()' value='$data[sred]'>"; ?><br>
Green:<? echo "<input id='sgreen' type='text' name='sgreen' size='3' maxlength='3' onChange='colourChange5()' value='$data[sgreen]'>"; ?><br>
Blue:<? echo "<input id='sblue' type='text' name='sblue' size='3' maxlength='3' onChange='colourChange5()' value='$data[sblue]'>"; ?><br>
