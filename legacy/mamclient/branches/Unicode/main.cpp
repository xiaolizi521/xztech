...
Socket login( Socket aSocket, Crypto *crypto, AccountInfo acct_info )
{
    ...
    if ( !strcmp( acct_info.servername, "GF" ) )
    {
        CPacket gfPacket = { 
            { 52, 1051 },
            {
                ...
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0xBB, 0xC6, 0xBD, 0xF0, 0xB4, 0xF3, 0xB5, 0xD8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
            }
        };
        loginPacket = gfPacket;
    }
    else
    {
        CPacket normalPacket = { 
            { 52, 1051 },
            {
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        strncpy( ( normalPacket.data + 32 ), acct_info.servername, 16 );
        
        loginPacket = normalPacket;
    }
    CPacket packet;
    char    g_address[16];
