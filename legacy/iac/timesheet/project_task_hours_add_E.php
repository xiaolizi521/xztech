<?
	...
	// Everything's good. Lets add it to the database.
	if( $flag )
	{
		$dbarray = array( "project_task_id" => $post['id'], "hours" => $hours, "notes" => $post['notes'], "date" => $post['month']."/".$post['day']."/".$post['year'], "approved" => "0" );
...
<p><a href="project_task_hours_clock.php?task=<?= $id ?>&c=in" alt="Clock in"><img src="images/startclock.gif" alt="Start Clock"></a></p>
<table cellpadding="5">
	<tr>
		<td>Task:</td>
		<td><?= $row['name'] ?></td>
