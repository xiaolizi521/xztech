<?
    ...
    //$db->query( "SELECT c.id as c_id, c.organization as c_resource_name, c.username as c_username, c.password as c_password, c.notes as c_notes, c.organization FROM client c ORDER BY organization" );
    ...
    $db->query( "SELECT
                    ...
                    c.notes AS c_notes,
                    d.organization
                 FROM client_resources c, client d
