<?
	...
	if( sizeof( $post ) > 0 )
	{
		...
		$xml = new xmlarray( $result );
		$arrayData = $xml->createArray();
		$client_id = $arrayData['response']['client_id'];
		
		if( $client_id > 0 )
			header( "Location: clients.php" );
		else
			$error = $arrayData['response']['error'];
	}
...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="newTable pad">
	<tr>
	    ...
	    <td><input class="formTextMed" tabindex='1' type="text" name="organization" id="organization" value="<?= $post['organization'] ?>" maxlength="100"></td>
	    ...
	    <td><input class="formTextMedReq" tabindex='5' type='text' name='username' id="username" value="<?= $post['username'] ?>" maxlength="100"></td>
	</tr>
	<tr>
	    ...
	    <td><input class="formTextMedReq" tabindex='2' type="text" name="fname" id="fname" value="<?= $post['fname'] ?>" maxlength="100">
	...
	<tr>
	    ...
	    <td><input class="formTextMedReq" tabindex='3' type="text" name="lname" id="lname" value="<?= $post['lname'] ?>" maxlength=20></td>
	...
	<tr>
		...
		<td><input class="formTextMedReq" tabindex='4' type="text" name="email" id="email" value="<?= $post['email'] ?>" maxlength="100" onChange='updateUsername(email, username2);' ></td>
 ...
 <!-- <OPTION VALUE="S. Georgia and S. Sandwich Isls.">
  ...
  <OPTION VALUE="Zimbabwe">Zimbabwe
	...
	<tr>
	    ...
	    <td><input class="formTextMed" tabindex='110' type="text" name="p_street" id="p_street" value="<?= $post['p_street'] ?>" maxlength="100"></td>
	    ...
	    <td><input class="formTextMed" tabindex='114' type="text" name="s_street" id="s_street" value="<?= $post['s_street'] ?>" maxlength="100"></td>
	</tr>
	<tr>
		<td align="right"><div style="cursor:pointer;display:inline;" onClick="document.getElementById('p_street2').focus()"></div></td>

		<td><input class="formTextMed" tabindex='110' type="text" name="p_street2" id="p_street2" value="<?= $post['p_street2'] ?>" maxlength="100"></td>
	    <td align="right"><div style="cursor:pointer;display:inline;" onClick="document.getElementById('s_street2').focus()"></div></td>
    	<td><input class="formTextMed" tabindex='114' type="text" name="s_street2" id="s_street2" value="<?= $post['s_street2'] ?>" maxlength="100"></td>
	</tr>
	<tr>
		<td class="formTitle"><div style="cursor:pointer;display:inline;" onClick="document.getElementById('p_city').focus()">City:&nbsp;</div></td>
		<td><input class="formTextMed" tabindex='110' type="text" name="p_city" id="p_city" value="<?= $post['p_city'] ?>" maxlength="100"></td>
		<td  class="formTitle"><div style="cursor:pointer;display:inline;" onClick="document.getElementById('s_city').focus()">City:&nbsp;</div></td>
		<td><input class="formTextMed" tabindex='114' type="text" name="s_city" id="s_city" value="<?= $post['s_city'] ?>" maxlength="100"></td>
	</tr>
	<tr>
    	<td class="formTitle">Province/State:&nbsp;</td>
	    <td><input  class="formTextMed" ID="others" tabindex='110' TYPE="TEXT" NAME="p_state" SIZE="25" value="<?= $post['p_state'] ?>" maxlength="50" ></td>
	    <td class="formTitle">Province/State:&nbsp;</td>
	    <td><input  class="formTextMed" ID="others" tabindex='110' TYPE="TEXT" NAME="s_state" SIZE="25" value="<?= $post['s_state'] ?>" maxlength="50" ></td>
	</tr>
	<tr>
		...
		<td><input class="formTextMed" tabindex='110' type="text" name="p_code" id="p_code" value="<?= $post['p_code'] ?>" maxlength="100"></td>
	    ...
	    <td><input class="formTextMed" tabindex='116' type="text" name="s_code" id="s_code" value="<?= $post['s_code'] ?>" maxlength="100"></td>
	</tr>
	<tr>
	    ...
	    <td><input class="formTextMed" tabindex='111' type="text" name="bus_phone" id="bus_phone" value="<?= $post['bus_phone'] ?>" maxlength="100"></td>
	...
	<tr>
		...
		<td><input class="formTextMed" tabindex='112' type="text" name="mob_phone" id="mob_phone" value="<?= $post['mob_phone'] ?>" maxlength="100"></td>
    	<td colspan="2" rowspan='4' align="center" valign="top"><textarea class="formAreaThin" tabindex='116' name='note' id="note"><?= $post['note'] ?></textarea></td>
	</tr>
	...
	<tr>
	    ...
	    <td><input class="formTextMed" tabindex='112' type="text" name="home_phone" id="home_phone" value="<?= $post['home_phone'] ?>" maxlength="100"></td>
	</tr>
	<tr>
		...
		<td><input class="formTextMed" tabindex='113' type="text" name="fax" id="fax" value="<?= $post['fax'] ?>" maxlength="100"></td>
	</tr>
 </table>
</fieldset>
