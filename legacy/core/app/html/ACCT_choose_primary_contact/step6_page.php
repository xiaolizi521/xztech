...
<HTML>
<HEAD>
<TITLE>Choose Primary Contact Wizard - 6</TITLE>
...
<FORM ACTION="step6_handler.php">
    <DIV ALIGN="center"> 
        <TABLE BORDER="1" CELLSPACING="0" CELLPADDING="1" WIDTH="80%">
            <TR> 
                <TD BGCOLOR="#003399"><B><FONT COLOR="#FFFFFF">&nbsp;Choose Primary Contact </FONT></B>
                </TD> 
            </TR>
            <TR> 
                <TD BGCOLOR="#CCCCCC"> 
